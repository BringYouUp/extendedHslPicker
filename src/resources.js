...
import IMG_COPIED_URL from '@assets/images/shared.png'
import IMG_RANDOM from '@assets/images/random.png'
import IMG_ADD from '@assets/images/add.png'
import IMG_ADDED from '@assets/images/added.png'
import IMG_CLOSED_LIST from '@assets/images/caret-right.png'

export { IMG_COPIED_URL, IMG_MENU, IMG_BACK, IMG_HELP, IMG_COPY_COLOR, IMG_COPY_URL, IMG_RANDOM, IMG_ADD, IMG_ADDED, IMG_CLOSED_LIST }